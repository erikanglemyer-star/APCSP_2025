...
transportation = float(input("Enter your transportation cost for the month: $"))

totalExpenses = rent + groceries + utilities + entertainment + transportation
...
essentialExpenses = rent + utilities + groceries + transportation
